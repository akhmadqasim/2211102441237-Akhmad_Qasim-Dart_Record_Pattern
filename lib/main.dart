...
import 'data.dart'; // Assuming you have a data.dart file with the Document class defined
...
class DocumentApp extends StatelessWidget {
  const DocumentApp({super.key}); // Fixed the constructor
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: DocumentScreen(
        document: Document(), // Assuming Document() returns an instance of the Document class
      ),
    );
  }
}
...
class DocumentScreen extends StatelessWidget {
  ...
  }); // Added super(key: key) to call the superclass constructor
